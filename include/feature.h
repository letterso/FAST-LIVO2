...
struct Feature
{
  ...
  Eigen::Isometry3d T_f_w_; //!< Pose of the frame where the patch feature was extracted.
  ...
  Feature(VisualPoint *_point, float *_patch, const Vector2d &_px, const Vector3d &_f, const Eigen::Isometry3d &_T_f_w, int _level)
